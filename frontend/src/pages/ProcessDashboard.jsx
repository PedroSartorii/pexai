...
export default function ProcessDashboard() {
  ...
  const [form, setForm] = useState({
    authorName: "", defendantName: "", cpfCnpj: "",
    vara: "", caseValue: "", narrative: "",
  });
  ...
  async function handleDownload(id) {
    setLoadingDocx(id);
    try { await downloadDocx(id); }
    catch { setError("Erro ao baixar documento."); }
    finally { setLoadingDocx(null); }
  }
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0a0a0f", fontFamily: "'DM Sans', sans-serif", display: "flex" }}>
      ...
      <div style={{ marginLeft: 220, flex: 1, padding: "48px 48px 48px 48px" }}>
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>

          {/* Título */}
          <div style={{ marginBottom: 40 }}>
            <p style={{ fontSize: 11, fontWeight: 500, letterSpacing: "0.2em", textTransform: "uppercase", color: "#d4af37", marginBottom: 8 }}>
              Nova peça jurídica
            </p>
            ...
            <form onSubmit={handleSubmit}>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24, marginBottom: 24 }}>
                <div>
                  ...
                  <input name="authorName" type="text" required placeholder="Nome completo do autor"
                ...
                <div>
                  ...
                  <input name="defendantName" type="text" required placeholder="Nome completo do réu"
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 24, marginBottom: 24 }}>
                <div>
                  ...
                  <input name="cpfCnpj" type="text" required placeholder="000.000.000-00"
                ...
                <div>
                  ...
                  <input name="vara" type="text" required placeholder="Ex: 1ª Vara Cível"
                ...
                <div>
                  ...
                  <input name="caseValue" type="number" required placeholder="0,00" min="0" step="0.01"
              ...
              <div style={{ marginBottom: 32 }}>
                ...
                <textarea name="narrative" required placeholder="Descreva os fatos do processo em detalhes..."
          ...
          <div>
            ...
            {processes.length === 0 ? (
              <div style={{ background: "#111118", border: "1px solid rgba(212,175,55,0.08)", borderRadius: 4, padding: 48, textAlign: "center", color: "#444" }}>
                ...
                {processes.map((p) => (
                  ...
                  >
                    ...
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                      ...
                      <button onClick={() => handleDownload(p.id)} disabled={loadingDocx === p.id}
